...
CR_KINDS = [
    "entities.helper.hybridsovereign.redhat",
    "personas.helper.hybridsovereign.redhat",
    "teams.helper.hybridsovereign.redhat",
    "assignments.helper.hybridsovereign.redhat",
    "projects.helper.hybridsovereign.redhat",
    "platformopenshifts.helper.hybridsovereign.redhat",
    "cloudosos.helper.hybridsovereign.redhat",
    "cloudaws.helper.hybridsovereign.redhat",
    "openstackmigrations.helper.hybridsovereign.redhat",
    "rbacs.helper.hybridsovereign.redhat",
    "rbacconfigs.helper.hybridsovereign.redhat",
    "vaults.helper.hybridsovereign.redhat",
    "vaultkvs.helper.hybridsovereign.redhat",
    "aapconfigs.helper.hybridsovereign.redhat",
    "aaporgs.helper.hybridsovereign.redhat",
    "quayconfigs.helper.hybridsovereign.redhat",
    "quayorgs.helper.hybridsovereign.redhat",
    "iaacs.helper.hybridsovereign.redhat",
]
